...
export const Default: StoryObj = {
  render: () => (
    <Badge color="#2563eb" bgColor="#2563eb20">
      Label
    </Badge>
  ),
};
export const Category: StoryObj = {
  render: () => (
    <CategoryBadge category="proteins" label="Proteins" colors={colors} />
  ),
};
export const Status: StoryObj = {
  render: () => (
    <StatusBadge status="delivered" label="Delivered" colors={colors} />
  ),
};

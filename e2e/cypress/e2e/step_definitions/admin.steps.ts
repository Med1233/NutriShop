...
Given('I am logged in as the default admin', () => {
  cy.seedUser({ email: 'admin@test.com', password: 'admin1234', name: 'Test Admin', role: 'admin' });
...
When('I create a user with name {string} email {string} password {string} role {string}',
